export const surpriseMePrompts = [
    ...
    'celestial space, nebulas, flyable humanoid, glance through the visor, seconds away from portal',
    'new generic isekai anime poster with main character and bunch of girls in front, ultra HD',
    'heavy arms gundam penguin mech',
    'Paco Bouazza on horse slaying a terrifying dragon',
    'Lightning, orange color, Paris',
    'middle eastern young woman wearing a kimono fighting with a glowing red katana',
    'great king ultra detailed art',
    'sleeping in dark night with full moon sky',
    'area of rocks, deep inside the forest, divine domain',
    'cute panda with bayern munchen jersey realistic',
    'enchanted forest, with a path between the trees, sun shining, close up, Cinematic Lighting, 3d, render, hyper detailed',
    'God, 8K',
  ];